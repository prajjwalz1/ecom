...
class OrderItem(CustomizedModel):
    order=models.ForeignKey('Order',on_delete=models.SET_DEFAULT,default="deleted_order")
    product=models.ForeignKey(Product,on_delete=models.SET_DEFAULT,default="deleted_product")
