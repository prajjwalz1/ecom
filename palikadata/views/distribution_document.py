...
from palikadata.models.distribution import DistributionDocument
from palikadata.serializers.item_distribution import DistributionDocumentSerializer


class DistributionDocumentViewSet(viewsets.ModelViewSet, ResponseMixin):
    """
    A viewset for viewing and editing PalikaData instances.
    """

    queryset = DistributionDocument.objects.all()
    serializer_class = DistributionDocumentSerializer
