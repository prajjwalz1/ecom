...
urlpatterns = [
    ...
    path(
        "specifications/",
        views.SpecificationListCreateView.as_view(),
        name="specification-list-create",
    ),
    path(
        "specifications/<int:pk>/",
        views.SpecificationRetrieveUpdateDestroyView.as_view(),
        name="specification-retrieve-update-destroy",
    ),
    # CarouselImage API Endpoints
    path(
        "carousel-images/",
        views.CarouselImageListCreateView.as_view(),
        name="carousel-image-list-create",
    ),
    path(
        "carousel-images/<int:pk>/",
        views.CarouselImageRetrieveUpdateDestroyView.as_view(),
        name="carousel-image-retrieve-update-destroy",
    ),
    ...
    path(
        ...
        name="navbar-retrieve-update-destroy",
    ),
    path(
    ...
    path(
        ...
        name="productimage-list-create",
    ),
    path(
        "productimage/<int:pk>/",
        views.ProductImageUpdateDestroyView.as_view(),
        name="productimage-update-destroy",
    ),
    path(
        "productimagewithoutvariant/",
        views.ProductImageWithoutVariantCreateView.as_view(),
        name="productimage-novariant-list-create",
    ),
    path(
        "productimagewithoutvariant/<int:pk>/",
        views.ProductImageWithoutVariantUpdateDestroyView.as_view(),
        name="productimage-novariant-update-destroy",
    ),
    path(
        "productvariant/",
        views.ProductVariantListCreateView.as_view(),
        name="productvariant-list-create",
    ),
    path(
        "productvariant/<int:pk>/",
        views.ProductVariantUpdateDestroy.as_view(),
        name="productvariant-update-destroy",
    ),
    path(
        "variantcolors/",
        views.ColorsListCreateView.as_view(),
        name="variantcolors-list-create",
    ),
    path(
        "variantcolors/<int:pk>/",
        views.ColorsUpdateDistroyView.as_view(),
        name="variant-update-destroy",
    ),
]
