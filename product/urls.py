...
urlpatterns = [
    ...
    path('variantcolors/', views.ColorsListCreateView.as_view(), name='variantcolors-list-create'),
    path('variantcolors/<int:pk>/', views.ColorsUpdateDistroyView.as_view(), name='variant-update-destroy'),
